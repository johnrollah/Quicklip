...
var dynamicSearch = new require('./lib/dynamicsearch')();
var tray = require('./lib/tray')(gui, qk, dynamicSearch);
...
setInterval(function(){
  ...
  if(changed && global.preferences.dynamicsearch.autoscan) {
    changed = null;
    var matched = dynamicSearch.scanString(qk.clips[0]);
    if(matched.length){
      ...
      setTimeout(function() {
        ...
        setTimeout(function(){dynamicSearch.resetMatched()},1000);
      },200);
    }
  }
},10);
